  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Sky-Transfer xizmati foydalanish qoidalari</p>
      </div>
      ...
      <Card className="bg-gradient-card border-0 shadow-card-custom">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm">
            Ushbu ommaviy oferta (keyingi o'rinlarda "Oferta") "Sky-Transfer" mobil ilovasi (keyingi o'rinlarda "Ilova") 
          ...
          <p className="text-sm">
            Xizmat "Sky-Transfer" MChJ tomonidan taqdim etiladi.
          </p>
        </CardContent>
      </Card>
