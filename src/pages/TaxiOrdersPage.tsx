...
const TaxiOrdersPage = () => {
  ...
  const getActionButton = (order) => {
    switch (order.status) {
      case "accepted":
        return (
          <Button onClick={() => openConfirmDialog("start", order.id)} className="flex-1 gap-2 bg-purple-600 hover:bg-purple-700 text-white text-base py-6" disabled={loading}>
      ...
      case "started":
        return (
          <Button onClick={() => openConfirmDialog("complete", order.id)} className="flex-1 gap-2 bg-orange-600 hover:bg-orange-700 text-white text-base py-6" disabled={loading}>
      ...
      case "stopped":
        return (
          <Badge className="bg-orange-500/20 text-orange-600 dark:text-orange-300 border border-orange-500/50 flex-1 justify-center py-4 text-base">
            Mijoz tasdiqini kutmoqda...
          </Badge>
        )
      case "completed":
        return (
          <Badge className="bg-slate-500/20 text-slate-600 dark:text-slate-300 border border-slate-500/50 flex-1 justify-center py-4 text-base">
            Yakunlangan
          </Badge>
        )
      default:
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="container mx-auto px-3 sm:px-4 max-w-7xl py-4 sm:py-6">
        <Card className="border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-900/50 backdrop-blur-sm shadow-xl">
          <CardHeader className="border-b border-slate-200 dark:border-slate-800 p-4 sm:p-6">
            <CardTitle className="text-2xl sm:text-3xl text-slate-900 dark:text-white flex items-center gap-3">
          ...
          <CardContent className="p-3 sm:p-4 md:p-6">
            <Tabs defaultValue="available" className="w-full">
              <TabsList className="grid grid-cols-2 gap-3 bg-slate-200 dark:bg-slate-800/50 p-2 h-auto mb-6 rounded-xl">
                <TabsTrigger 
                  value="available" 
                  className="data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 data-[state=active]:text-slate-900 dark:data-[state=active]:text-white data-[state=active]:shadow-lg text-slate-600 dark:text-slate-400 text-base py-3 rounded-lg transition-all"
                >
                      ...
                      <Card key={order.id} className="border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800/50 shadow-lg hover:shadow-xl transition-all overflow-hidden">
                        <CardHeader className="pb-4 border-b border-slate-200 dark:border-slate-700 p-5 bg-gradient-to-r from-blue-50 to-green-50 dark:from-slate-800 dark:to-slate-800">
                          <div className="flex items-start justify-between gap-3">
                            <div className="flex-1 min-w-0">
                              <CardTitle className="text-xl flex items-center gap-2 text-slate-900 dark:text-white mb-2">
                            ...
                            <Badge className="bg-green-500/20 text-green-600 dark:text-green-400 border border-green-500/50 flex-shrink-0 text-sm px-3 py-1">
                              Yangi
                            </Badge>
                          </div>
                        </CardHeader>
                        <CardContent className="space-y-4 pt-5 p-5">
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-base">
                            <div className="flex items-center gap-3 text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-900/50 p-3 rounded-lg">
                          ...
                          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-700 p-5 rounded-xl">
                            <div className="flex items-center justify-between mb-4">
                              <span className="text-base font-medium text-slate-700 dark:text-slate-200">Buyurtma narxi:</span>
                            ...
                            <div className="flex items-center justify-between pt-3 border-t border-green-200 dark:border-green-700">
                              <span className="text-sm text-slate-600 dark:text-slate-300">Komissiya (10%):</span>
                          ...
                          {order.note && (
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-2 border-blue-200 dark:border-blue-700">
                              <p className="text-sm font-semibold text-blue-700 dark:text-blue-300 mb-2">📝 Qo'shimcha ma'lumot:</p>
                              <p className="text-base text-blue-600 dark:text-blue-200">{order.note}</p>
                            </div>
                          )}

                          <div className="bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-200 dark:border-amber-700 p-4 rounded-xl flex items-start gap-3">
                            <AlertCircle className="w-6 h-6 text-amber-600 dark:text-amber-300 mt-0.5 flex-shrink-0" />
                          ...
                          <Button 
                            ...
                            className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-lg py-6 rounded-xl shadow-lg hover:shadow-xl transition-all"
                            disabled={loading}
                          >
                  ...
                  {completedOrders.length === 0 ? (
                    ...
                    completedOrders.map((order) => (
                      <Card key={order.id} className="border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800/50 shadow-lg">
                        <CardHeader className="pb-4 border-b border-slate-200 dark:border-slate-700 p-5">
                        ...
                        <CardContent className="space-y-4 pt-5 p-5">
                          ...
                          <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-xl border-2 border-green-200 dark:border-green-700">
                            <div className="flex items-center justify-between">
                              <span className="text-base text-green-700 dark:text-green-300 font-medium">Buyurtma narxi:</span>
                          ...
                          {order.phone && (
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-2 border-blue-200 dark:border-blue-700">
                              <p className="text-sm font-semibold text-blue-700 dark:text-blue-300 mb-2">📞 Mijoz ma'lumotlari:</p>
                              <div className="flex items-center gap-2">
                                <Phone className="w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0"/>
                                <a href={`tel:${order.phone}`} className="text-base text-blue-600 dark:text-blue-400 hover:underline font-medium">
                                  {order.phone}
                                </a>
                              </div>
                            </div>
                          ...
                          {order.histories && order.histories.length > 0 && (
                            <Button 
                              ...
                              variant="outline" 
                              className="w-full justify-center bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 border-2 border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white text-base py-5 rounded-xl"
                            >
                          ...
                          {order.status !== "completed" && order.status !== "cancelled" && (
                            <div className="flex flex-col sm:flex-row gap-3">
                              ...
                              <Button
                                ...
                                variant="destructive"
                                className="flex-1 bg-red-600/20 border-2 border-red-500/50 text-red-600 dark:text-red-400 hover:bg-red-600/30 text-base py-6 rounded-xl"
                                disabled={loading}
                              >
        ...
        <Dialog open={priceDialog.open} onOpenChange={(open) => setPriceDialog({...priceDialog, open})}>
          <DialogContent className="sm:max-w-lg bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-700 max-w-[calc(100%-2rem)] mx-4">
            <DialogHeader>
              <DialogTitle className="text-slate-900 dark:text-white text-xl">Buyurtma tafsilotlari</DialogTitle>
            ...
            {priceDialog.order && (
              <div className="space-y-4">
                <div className="bg-slate-100 dark:bg-slate-800/80 border-2 border-slate-300 dark:border-slate-600 p-4 rounded-xl">
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="w-5 h-5 text-blue-500 flex-shrink-0"/>
                    <p className="font-medium text-slate-900 dark:text-white text-base break-words">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-600 p-5 rounded-xl space-y-3">
                  <div className="flex items-center justify-between pb-3 border-b border-green-200 dark:border-green-600">
                    <span className="text-base font-medium text-slate-700 dark:text-slate-200">Buyurtma narxi:</span>
                    <span className="text-3xl font-bold text-green-600 dark:text-green-400">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600 dark:text-slate-300">To'lov summasi (10%):</span>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-200 dark:border-amber-700 p-4 rounded-xl">
                  <div className="flex items-start gap-3">
                    <AlertCircle className="w-6 h-6 text-amber-600 dark:text-amber-300 mt-0.5 flex-shrink-0"/>
                    <div className="text-sm text-amber-800 dark:text-amber-200">
                      <p className="font-semibold mb-1">⚠️ Muhim:</p>
            ...
            <DialogFooter className="flex-col sm:flex-row gap-3">
              ...
              <Button 
                ...
                disabled={loading}
                className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white text-base py-5"
              >
