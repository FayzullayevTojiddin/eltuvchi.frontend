...
const TaxiEarningsPage = () => {
  const [currentBalance] = useState(275000)
  ...
  const [transactions] = useState([
    {
      ...
      type: "earning",
      amount: 50000,
      description: "Buyurtma #1234 - Toshkent shahar",
    ...
    },
    {
      ...
      type: "earning",
      amount: 75000,
      description: "Buyurtma #1233 - Yunusobod tumani",
  ...
  const getTransactionIcon = (type: string, status: string) => {
    ...
    if (type === "earning") return <Plus className="h-4 w-4 text-green-600" />
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 p-4 animate-fade-in">
      <div className="text-center">
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Daromad</h1>
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                    ...
                    <div className="text-left md:text-right">
                      <p className={`font-bold ${transaction.type === 'earning' ? 'text-green-600' : 'text-blue-600'}`}>
                        {transaction.type === 'earning' ? '+' : '-'}{transaction.amount.toLocaleString()} so'm
                      </p>
                    </div>
                  </div>
...
export default TaxiEarningsPage
